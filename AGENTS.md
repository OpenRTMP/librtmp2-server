...
- **Dependency source:** `librtmp2` resolves from crates.io (currently `0.9.1`). It does **not** use the sibling `../librtmp2` checkout unless you add a `[patch.crates-io]` override locally (see comment in `Cargo.toml`).
