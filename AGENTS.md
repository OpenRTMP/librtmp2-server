...
- **Dependency source:** `librtmp2 = { version = "0.4.1", features = ["tls"] }` resolves from crates.io. It does **not** use the sibling `../librtmp2` checkout unless you add a `[patch]` override locally.
